...
При создании отчета автоматически отправляется уведомление тренеру клиента (если тренер привязан), чтобы он мог просмотреть новый прогресс и оставить комментарий.
