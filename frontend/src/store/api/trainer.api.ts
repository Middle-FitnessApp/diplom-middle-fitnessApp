...
const mockClientProfiles: UserProfile[] = [
	{
		...
		photos: [
			'/photos/client1/front.jpg',
			'/photos/client1/side.jpg',
			'/photos/client1/back.jpg',
		],
	},
	{
		id: '2',
		...
		photos: [
			'/photos/client2/front.jpg',
			'/photos/client2/side.jpg',
			'/photos/client2/back.jpg',
		],
	},
]
...
export const trainerApi = createApi({
	...
	endpoints: (builder) => ({
		...
		getClients: builder.query<AuthUser[], string>({
